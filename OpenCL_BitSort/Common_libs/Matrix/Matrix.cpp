...
bool MF_help::ZeroOutElem(const Matrix_t<double>::SetterRaw_t &base,
                          ...
                          size_t num) {
  if (base.size() != current_str.size() || num >= base.size() ||
...
MF_help::CZUMout MF_help::CreateZeroUnderMatrix(VecRaw_t &vec, size_t num) {
...
MF_help::VecRaw_t
MF_help::TriangleMatrix(Matrix_t<double> &matrix,
