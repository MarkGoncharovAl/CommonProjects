...
namespace MLib {
template <class Type_t> struct Iterator {
  ...
  public:
    ...
    //  !Comparing
    ////////////////////////////////////////////////////////////////
    bool operator==(const ordinary_iterator &that) const noexcept {
  ...
  public:
    ...
    safe_iterator(Type_t *data, Type_t *end_data) noexcept
        : basic_iterator(data), end_data_(end_data) {}
    ////////////////////////////////////////////////////////////////
    ...
    Type_t &operator*() {
      if (data_ >= end_data_)
        throw std::out_of_range(
            "Reaching the edge of massive of iterators!"); // I can't return
                                                           // anything!!! ->
                                                           // kill
    ...
    //  !Comparing
    ////////////////////////////////////////////////////////////////
    bool operator==(const safe_iterator &that) const noexcept {
      return data_ == that.data_;
    }
    bool operator!=(const safe_iterator &that) const noexcept {
      return data_ != that.data_;
...
template <class T> using M_iterator = typename Iterator<T>::ordinary_iterator;
template <class T> using MC_iterator = typename Iterator<T>::const_iterator;
template <class T> using MS_iterator = typename Iterator<T>::safe_iterator;
